...
class FactName(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.region_info.FactName"):
    ...
    @jsii.python.classproperty
    @jsii.member(jsii_name="DEFAULT_CR_NODE_VERSION")
    def DEFAULT_CR_NODE_VERSION(cls) -> builtins.str:
        '''The default NodeJS version used for custom resource function runtimes.'''
        return typing.cast(builtins.str, jsii.sget(cls, "DEFAULT_CR_NODE_VERSION"))
