...
class CertificateProps:
    def __init__(
        ...
        *,
        ...
        :param certificate_name: The Certifcate name. Since the Certifcate resource doesn't support providing a physical name, the value provided here will be recorded in the ``Name`` tag Default: the full, absolute path of this construct
