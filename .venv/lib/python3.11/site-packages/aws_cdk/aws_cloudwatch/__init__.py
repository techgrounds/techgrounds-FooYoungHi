...
class CfnInsightRule(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[_IResolvable_da3f097b, typing.Union[_CfnTag_f6864754, typing.Dict[builtins.str, typing.Any]]]]]] = None,
    ) -> None:
...
class Dashboard(
    ...
    def __init__(
        ...
        *,
        ...
        :param default_interval: Interval duration for metrics. You can specify defaultInterval with the relative time(eg. cdk.Duration.days(7)). Default: When the dashboard loads, the defaultInterval time will be the default time range.
